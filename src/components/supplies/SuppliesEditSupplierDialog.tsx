...
interface SuppliesEditSupplierDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  supplier: PharmacySupplier;
}

export function SuppliesEditSupplierDialog({ open, onOpenChange, supplier }: SuppliesEditSupplierDialogProps) {
        ...
        <DialogContent className="max-w-3xl">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4 py-4">
              ...
              {/* Row 3: Teléfono, Email, Categoría */}
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  <Label htmlFor="edit-specialty" className="text-xs">Categoría</Label>
                  <Input
                    id="edit-specialty"
                    className="h-9"
