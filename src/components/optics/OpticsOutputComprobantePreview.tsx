...
interface OpticsOutputComprobantePreviewProps {
  open: boolean;
...
export function OpticsOutputComprobantePreview({
  open,
  onOpenChange,
  numeroComprobante,
  fecha,
  ...
  total,
  config
}: OpticsOutputComprobantePreviewProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center justify-between">
            <span>Vista Previa - Comprobante de Óptica</span>
          ...
          <CardContent className="p-6">
            ...
            >
              ...
              <div className="text-center">
                <div>-----------------------------------------------</div>
                <div className="font-bold">COMPROBANTE DE SALIDA ÓPTICA</div>
              ...
              {products.map((item, index) => (
                <div key={index} className="space-y-0">
                  <div className="grid grid-cols-12 gap-1 text-xs">
                    ...
                    <span className="col-span-5">{item.nombre}</span>
