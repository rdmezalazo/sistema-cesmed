...
import { OpticsNewSupplierDialog } from "./OpticsNewSupplierDialog";
import { OpticsEditSupplierDialog } from "./OpticsEditSupplierDialog";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function OpticsSuppliersPage() {
  ...
  // Filter by specialty "oftalmología" (case insensitive) and search term
  const filteredSuppliers = suppliers?.filter(supplier => {
    const hasOftalmologiaSpecialty = supplier.specialty?.toLowerCase().includes("oftalmolog");
    ...
    return hasOftalmologiaSpecialty && matchesSearch;
  }) || [];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Administra los proveedores de productos ópticos
          </p>
        </div>
              ...
              <Table className="relative border-separate border-spacing-0">
                <TableHeader className="sticky top-0 z-10 bg-card shadow-sm border-b">
                  <TableRow className="hover:bg-transparent">
                    ...
                    <TableHead className="bg-card">Línea</TableHead>
      ...
      <OpticsNewSupplierDialog
        open={showNewDialog}
        onOpenChange={setShowNewDialog}
      />

      {selectedSupplier && (
        <OpticsEditSupplierDialog
          open={showEditDialog}
