...
interface OpticsNewSupplierDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function OpticsNewSupplierDialog({ open, onOpenChange }: OpticsNewSupplierDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Registra un nuevo proveedor de productos ópticos
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-1">
                <Label htmlFor="specialty" className="text-xs">Especialidad</Label>
                <Input
                  id="specialty"
                  className="h-9"
