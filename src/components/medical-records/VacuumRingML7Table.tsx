...
interface VacuumRingML7TableProps {
...
export function VacuumRingML7Table({ formData, onFieldChange, section }: VacuumRingML7TableProps) {
  ...
  const findFieldId = (eye: 'od' | 'oi') => {
    ...
    const contextTokens = [
      'anillo de vacio', 'anillo de vacio ml 7', 'anillo de vacio ml7',
      'anillo de vacio ml-7', 'anillo de vacio ml', 'anillo vacio',
      'anillo de vacio 7', 'anillo de vacio ml7', 'anillo de vacio ml-7',
      'anillo de vacio ml.7', 'anillo de vacio m l 7',
      'anillo de vacio ml', 'ml 7', 'ml7', 'ml-7', 'vacuum ring',
      'anillo de vacio ml7', 'anillo de vacio #7', 'anillo vacio', 'anillo',
    ].map(normalize);
