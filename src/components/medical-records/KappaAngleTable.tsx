...
interface KappaAngleTableProps {
...
export function KappaAngleTable({ formData, onFieldChange, section }: KappaAngleTableProps) {
  ...
  const findFieldId = (eye: 'od' | 'oi') => {
    ...
    // Prefer fields that mention the eye plus context keywords (ángulo/kappa/mm)
    const contextTokens = ['angulo', 'kappa', 'mm'];
