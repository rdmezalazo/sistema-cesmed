...
interface ScotopicPupilDiameterTableProps {
...
export function ScotopicPupilDiameterTable({ formData, onFieldChange, section }: ScotopicPupilDiameterTableProps) {
  ...
  const findFieldId = (eye: 'od' | 'oi') => {
    ...
    // Prefer fields that mention the eye plus context keywords (diameter/pupil/escotopic/mm)
    const contextTokens = ['diametro', 'pupilar', 'escotopica', 'mm'];
