...
export function KardexSuministros() {
  ...
  const { data: movements, isLoading } = useKardexMovements({ sistema: 'suministros' });
  const { data: summary } = useKardexSummary();

  const suministrosSummary = summary?.find(s => s.sistema === 'Suministros');
  ...
  const handleRefresh = () => {
    ...
    toast({
      title: "Actualizado",
      description: "Los datos de Suministros se han actualizado.",
    });
  };
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Kardex Suministros");
    XLSX.writeFile(wb, `kardex_suministros_${format(new Date(), "yyyyMMdd_HHmm")}.xlsx`);
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-teal-700">
              Kardex Suministros
            </h2>
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handleExportExcel} disabled={!filteredMovements?.length} className="bg-teal-600 hover:bg-teal-700">
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{suministrosSummary?.total_productos || 0}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{suministrosSummary?.total_entradas || 0}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">{suministrosSummary?.total_salidas || 0}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{suministrosSummary?.productos_bajo_stock || 0}</p>
              </div>
